...
Welcome to the contributor guide of hatchlor-template-test.
...
If you experience bugs or general issues with hatchlor-template-test, please have a look
...
You can help improve the documentation of hatchlor-template-test by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/hatchlor_template_test.git
   cd hatchlor_template_test
   ```
